 ...
 * }
 * 
 * @see http://brettbeauregard.com/blog/2011/04/improving-the-beginners-pid-
 *      direction/improving-the-beginners-pid-introduction
 */
public class MiniPID {
	 ...
	 * changes
	 * <li>Adds "drag" and slows the system when moving toward the
	 * target </list> A small D value can be useful for both improving response
	 * times, and preventing overshoot. However, in many systems a large D value
	 * will cause significant instability, particularly for large setpoint
	 * changes. <br>
